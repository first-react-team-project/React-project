...
//             {filteredTasks.length > 0 ? (
//                 <div className="flex flex-wrap gap-y-4 gap-x-14 justify-center  overflow-y-scroll mt-5 h-[80vh] sm:h-[78vh] scrollbar-hide">
//                     {filteredTasks.map((task) => (
//                         <TaskCard
//                             key={task.id}
//                             id={task.id}
...
//                 </div>
//             ) : (
//                 <div className="text-xl text-center text-indigo-500">No Tasks Available</div>
//             )}
//         </div>
//     );
// };
